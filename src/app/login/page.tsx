      ...
      <section className="relative z-10 grid w-full max-w-6xl gap-4 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
        <div className="rounded-[1.6rem] border border-lexos-gold/20 bg-gradient-to-br from-lexos-panel/95 via-lexos-navy/90 to-lexos-ink p-7 shadow-premium lg:p-10">
          <div className="flex items-center gap-4">
            <span className="grid h-20 w-16 place-items-center rounded-[8px] border border-lexos-cyan/18 bg-lexos-ink/42 shadow-[0_0_34px_rgba(110,217,255,0.12)]">
              <Image alt="LEX.OS" className="h-16 w-14 object-contain" height={76} priority src="/lexos-logo.png" width={64} />
            </span>
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.34em] text-lexos-cyan">
                LEX.OS Control
              </p>
              <p className="mt-1 font-mono text-[10px] uppercase tracking-[0.20em] text-lexos-muted">Sistema 2.0</p>
            </div>
          </div>
