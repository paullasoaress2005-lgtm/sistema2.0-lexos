...
export const lgpdChecklistItems: SecurityChecklistItem[] = [
  ...
  { title: "Evitar documentos sensíveis desnecessários", detail: "Não insira documentos sigilosos fora do escopo do MVP controlado.", status: "atencao" },
  ...
  { title: "Não armazenar documentos sigilosos fora do escopo", detail: "Use campos do MVP apenas para dados operacionais necessários.", status: "manual" },
